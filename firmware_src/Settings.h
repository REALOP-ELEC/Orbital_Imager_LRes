...
#define NSS PB6                                  //select pin on LoRa device
#define NRESET PA9                                //reset pin on LoRa device
#define LED1 PA5                                  //on board LED, high for on
#define DIO0 PA8                                  //DIO0 pin on LoRa device, used for RX and TX done 
#define DIO1 -1                                 //DIO1 pin on LoRa device, normally not used so set to -1 
#define DIO2 PC7                                  //DIO2 pin on LoRa device can be used for tone
